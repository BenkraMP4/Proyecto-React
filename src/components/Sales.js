...
class Sales extends React.Component{
    ...
    addtoCart = () => {
        ...
        let errors = "";
        let qty = document.getElementById("gty").value;
        ...
        errors += isPercentage && parseInt(discount.replace("%","")) > product.MDPercentege ? "No se puede descontar mas del "+product.MDPercentege+"%\n" : "";
        errors += !isPercentage && parseInt(discount) > product.MDPrice ? "No puede descontar mas de $"+product.MDPercentege+".\n" :"";
                        ...
                        <div className="row mb-2">
                            ...
                            <div className="col-sm-6">
                                <ol className="breadcrumb float-sm-right">
                                    <li className="breadcrumb-item"><a href="/#">Gigantes del Pacifico</a></li>
